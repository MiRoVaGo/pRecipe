...
#' @param data a csv generated by \code{\link{fldmean}}
#' @param ref a csv to be used as reference in the same format as that generated by \code{\link{fldmean}}. I.e., with columns: "date", "value", "name", and "type".
