...
#' @param var character string with the name of the variable to be used for the axis title
#' @param unit character string with the variable's unit of measurement to be used for the axis title
