...
MSWEP v2.8 | 0.1$^\circ$ | Global | Monthly | 1979/02-2022/06 | [Download](https://www.gloh2o.org/mswep/) | @beck_mswep_2019
...
* *domain* is set to "raw" by default, but you can specify the domain of your interest only (e.g., "ocean" for ocean only data sets).
