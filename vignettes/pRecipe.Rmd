...
```{r}
central_europe <- raster::raster("./data/processed/era5_tp_mm_subset_1981_2020_025_monthly.nc")
...
```{r}
czechia <- raster::raster("./data/processed/era5_tp_mm_subset_1981_2020_025_monthly_cropped.nc")
plot_map(czechia)
```
