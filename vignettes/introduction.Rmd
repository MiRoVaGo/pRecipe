...
* `regrid` to go from the native resolution (0.25°) to coarser ones (e.g., 0.5°, 1°, 1.5°, ...).
* `sellonlatbox` to subset the data to the region of interest.
* `selyear` to to select the years of interest.
* `subset_data` to subset the data in time and space.
...
* *x* is the path to the data set of interest or a RasterBrick object.
...
Let's subset the GPM-IMERGM data set over South America (-96, -30, -56, 24) for the 2001-2015 period, and inspect its content with `show_info`:
...
[5] "crs        : +proj=longlat +datum=WGS84 +no_defs "
[6] "source     : r_tmp_2023-07-06_190449.438575_97380_98378.grd "
...
[8] "min values : 4.547474e-13, 4.547474e-13, 4.547474e-13, 4.547474e-13, 4.547474e-13, 4.547474e-13, 4.547474e-13, 4.547474e-13, 4.547474e-13, 4.547474e-13, 4.547474e-13, 4.547474e-13, 4.547474e-13, 4.547474e-13, 4.547474e-13, ... "
[9] "max values :    1094.3127,     884.3267,    1101.6135,     928.9261,    1516.3088,    1148.8152,    1368.1981,    1475.1790,    1669.7684,    1184.4513,    1717.8375,    1192.6195,     906.7349,     856.1358,     846.0883, ... "
